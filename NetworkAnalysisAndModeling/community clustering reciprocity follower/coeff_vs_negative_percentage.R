...
plot(xrange,yrange, type="n", xlab="reciprocity", ylab="negative percentage of posts", cex.lab=1.5,cex.axis=1.5)
lines(fpe$reciprocity, fpe$negPercentage, type="p", lwd=3,lty=1, col="red", pch=1,cex=1.5)
