...
f = open("community_graph_data_follower.txt","r")
...
calculateCorrelation(coeff,posPer)
calculateCorrelation(coeff,posSev)
calculateCorrelation(coeff,negPer)
calculateCorrelation(coeff,negSev)
calculateCorrelation(reciprocity,posPer)
calculateCorrelation(reciprocity,posSev)
calculateCorrelation(reciprocity,negPer)
calculateCorrelation(reciprocity,negSev)
