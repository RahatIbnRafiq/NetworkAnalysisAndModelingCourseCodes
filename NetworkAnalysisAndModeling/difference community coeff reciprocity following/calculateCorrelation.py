...
for line in f:
    ...
    reciprocity.append(values[1])
    perratio.append(values[2])
    sevratio.append(values[3])
f.close()


calculateCorrelation(coeff,perratio)
calculateCorrelation(coeff,sevratio)
calculateCorrelation(reciprocity,perratio)
calculateCorrelation(reciprocity,sevratio)
