...
fpe<-read.table("Per_User_negativity.txt", sep=",")
...
plot(xrange,yrange, type="n", xlab="Local Clustering Coefficient", ylab="negative percentage of posts", cex.lab=1.5,cex.axis=1.5)
